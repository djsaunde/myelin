...
SMOKE_SPECS: tuple[BenchmarkSpec, ...] = (
    BenchmarkSpec(
        name="headline",
        module="myelin.benchmarks.headline",
        args=(),
    ...
    BenchmarkSpec(
        ...
        module="myelin.benchmarks.generated_forward",
        args=(
            "--timesteps",
            "16",
            "--batch",
    ...
    BenchmarkSpec(
        name="packed_forward",
        module="myelin.benchmarks.packed_forward",
        args=("--shape", "16,8,64", "--warmup", "1", "--repeats", "1"),
        artifact_stem="packed_forward_smoke",
    ),
    BenchmarkSpec(
        name="rate_readout",
        module="myelin.benchmarks.rate_readout",
        args=(
            "--shape",
            "16,8,10",
            "--features",
    ...
    BenchmarkSpec(
        ...
        module="myelin.benchmarks.scalar_loss_boundary",
        args=(
            "--shape",
            "16,8,64",
            "--features",
    ...
    BenchmarkSpec(
        ...
        module="myelin.benchmarks.performance_frontier",
        args=(
            "--timesteps",
            "16",
            "--batch",
    ...
    BenchmarkSpec(
        ...
        module="myelin.benchmarks.training_breakdown",
        args=(
            "--timesteps",
            "16",
            "--batch",
    ...
    BenchmarkSpec(
        ...
        module="myelin.benchmarks.compile_triton_boundary",
        args=(
            "--timesteps",
            "16",
            "--batch",
    ...
    BenchmarkSpec(
        ...
        module="myelin.benchmarks.compile_triton_sweep",
        args=(
            "--shape",
            "16,8,16,64",
            "--checkpoint-size",
    ...
    BenchmarkSpec(
        ...
        module="myelin.benchmarks.custom_neuron_module",
        args=(
            "--variant",
            "all",
            "--timesteps",
    ...
    BenchmarkSpec(
        ...
        module="myelin.benchmarks.custom_surrogate_training",
        args=(
            "--timesteps",
            "16",
            "--batch",
    ...
    BenchmarkSpec(
        ...
        module="myelin.benchmarks.online_learning",
        args=(
            "--timesteps",
            "4",
            "--batch",
    ...
    BenchmarkSpec(
        ...
        module="myelin.benchmarks.hardware_export",
        args=(
            "--in-features",
            "3",
            "--out-features",
    ...
    BenchmarkSpec(
        name="spikegpt_generation",
        module="myelin.benchmarks.spikegpt_generation",
        args=(
            "--batch",
            "1",
            "--prompt-tokens",
        ...
        artifact_stem="spikegpt_generation_smoke",
        device_override="cpu",
    ),
    BenchmarkSpec(
        name="spikegpt_training",
        module="myelin.benchmarks.spikegpt_training",
        args=(
            "--batch",
            "1",
            "--context-length",
        ...
        artifact_stem="spikegpt_training_smoke",
        device_override="cpu",
    ),
    BenchmarkSpec(
        name="distributed_collectives_gloo",
        module="myelin.benchmarks.distributed_collectives",
        args=(
            "--backend",
            "gloo",
            "--world-size",
...
CORE_SPECS: tuple[BenchmarkSpec, ...] = (
    ...
    BenchmarkSpec(
        ...
        module="myelin.benchmarks.mnist_rate_matrix",
        args=(
            "--epochs",
            "2",
            "--train-limit",
    ...
    BenchmarkSpec(
        ...
        artifact_stem="spikegpt_generation",
    ),
    BenchmarkSpec(
        name="spikegpt_training",
        module="myelin.benchmarks.spikegpt_training",
        ...
        artifact_stem="spikegpt_training",
    ),
    BenchmarkSpec(
        name="custom_neuron_module",
        module="myelin.benchmarks.custom_neuron_module",
    ...
    BenchmarkSpec(
        ...
        module="myelin.benchmarks.surrogate_backend",
        args=(
            "--timesteps",
            "100",
            "--batch",
