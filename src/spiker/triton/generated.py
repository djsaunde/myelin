...
from spiker._optional import require_triton
...
from spiker.packing import packed_last_dim_size
from spiker.surrogates import SurrogateName
...
def load_generated_forward_kernel(
    ...
    *,
    ...
    filename = f"<spiker_generated_{function_name}>"
...
def load_generated_neuron_forward_kernel(
    ...
    *,
    ...
    resolved_module_name = (
        f"spiker_generated_{ir.name}_forward" if module_name is None else module_name
    )
...
def load_generated_lif_forward_kernel(function_name: str = "_generated_lif_forward_kernel") -> Any:
    ...
    return _load_generated_kernel_cached(
        kind="lif_forward",
        function_name=function_name,
        module_name="spiker_generated_lif",
...
def load_generated_alif_forward_kernel(
    ...
    return _load_generated_kernel_cached(
        kind="alif_forward",
        function_name=function_name,
        module_name="spiker_generated_alif",
...
def load_generated_izhikevich_forward_kernel(
    ...
    return _load_generated_kernel_cached(
        ...
        function_name=function_name,
        module_name="spiker_generated_izhikevich",
...
def load_generated_lif_surrogate_backward_kernel(
    ...
    return _load_generated_kernel_cached(
        ...
        function_name=function_name,
        module_name=f"spiker_generated_lif_{surrogate}_backward",
...
def load_generated_lif_surrogate_backward_packed_spikes_kernel(
    ...
    return _load_generated_kernel_cached(
        ...
        function_name=function_name,
        module_name=f"spiker_generated_lif_{surrogate}_backward_packed_spikes",
...
def load_generated_linear_lif_surrogate_backward_weight_bias_kernel(
    ...
    return _load_generated_kernel_cached(
        ...
        function_name=function_name,
        module_name=f"spiker_generated_linear_lif_{surrogate}_backward_weight_bias",
...
def load_generated_linear_lif_surrogate_backward_weight_bias_packed_spikes_kernel(
    ...
    return _load_generated_kernel_cached(
        ...
        function_name=function_name,
        module_name=(f"spiker_generated_linear_lif_{surrogate}_backward_weight_bias_packed_spikes"),
...
def load_generated_linear_lif_surrogate_checkpoint_backward_chunk_kernel(
    ...
    return _load_generated_kernel_cached(
        ...
        function_name=function_name,
        module_name=f"spiker_generated_linear_lif_{surrogate}_checkpoint_backward_chunk",
...
def load_generated_linear_lif_surrogate_checkpoint_backward_chunk_packed_spikes_kernel(
    ...
    return _load_generated_kernel_cached(
        ...
        function_name=function_name,
        module_name=f"spiker_generated_linear_lif_{surrogate}_checkpoint_backward_packed_spikes",
        source_factory=lambda: (
