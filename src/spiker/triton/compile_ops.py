...
from spiker.triton.lif import _linear_surrogate_lif_checkpoint_rate_forward_kernel

triton = require_triton()


@triton_op("spiker::linear_lif_checkpoint_rate_forward_no_bias", mutates_args={})
...
@triton_op("spiker::linear_lif_checkpoint_rate_forward_bias", mutates_args={})
...
@custom_op("spiker::linear_lif_checkpoint_rate_grads_no_bias", mutates_args={})
...
@custom_op("spiker::linear_lif_checkpoint_rate_grads_bias", mutates_args={})
