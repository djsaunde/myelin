...
from spiker.benchmarks.lif import format_memory, format_ms, format_speedup, gpu_name, parse_shape
from spiker.neurons import LIFParams, LIFState
from spiker.packing import packed_spike_bytes
...
def run_one(
    ...
    *,
    ...
    from spiker.triton import lif_forward, pack_spikes_triton, unpack_spikes_triton
