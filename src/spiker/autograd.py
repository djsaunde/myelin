...
from spiker.surrogates import SurrogateName, surrogate_derivative, surrogate_from_name
...
class TritonSurrogateLIFFunction(torch.autograd.Function):
    ...
    def forward(
        ...
        from spiker.triton import pack_spikes_triton, surrogate_lif_forward
    ...
    def backward(
        ...
        *grad_outputs: torch.Tensor | None,
        ...
        from spiker.triton import surrogate_lif_backward_packed_spikes
...
class GeneratedTritonSurrogateLIFFunction(torch.autograd.Function):
    ...
    def backward(
        ...
        *grad_outputs: torch.Tensor | None,
        ...
        pre_reset_membranes, packed_spikes = ctx.saved_tensors
        from spiker.triton import generated_lif_surrogate_backward_packed_spikes
...
class TwoLayerSurrogateLIFRatePackedHiddenFunction(torch.autograd.Function):
    ...
    def backward(
        ...
        *grad_outputs: torch.Tensor | None,
        ...
        from spiker.triton import linear_surrogate_lif_checkpoint_backward, unpack_spikes_triton
...
class TritonLinearSurrogateLIFFunction(torch.autograd.Function):
    ...
    def backward(
        ...
        *grad_outputs: torch.Tensor | None,
        ...
        inputs, weight, _bias, pre_reset_membranes, spikes = ctx.saved_tensors
        from spiker.triton import linear_surrogate_lif_backward
...
class GeneratedTritonLinearSurrogateLIFFunction(torch.autograd.Function):
    ...
    def forward(
        ...
        from spiker.triton import linear_surrogate_lif_forward, pack_spikes_triton
...
class TritonLinearSurrogateLIFCheckpointFunction(torch.autograd.Function):
    ...
    def forward(
        ...
        from spiker.triton import linear_surrogate_lif_checkpoint_forward
    ...
    def backward(
        ...
        *grad_outputs: torch.Tensor | None,
        ...
        from spiker.triton import linear_surrogate_lif_checkpoint_backward
...
class GeneratedTritonLinearSurrogateLIFCheckpointRateFunction(torch.autograd.Function):
    ...
    def backward(
        ...
        *grad_outputs: torch.Tensor | None,
        ...
        inputs, weight, bias, chunk_start_membranes = ctx.saved_tensors
        from spiker.triton import generated_linear_lif_surrogate_checkpoint_backward
