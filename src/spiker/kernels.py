...
from spiker._optional import has_triton, require_triton
from spiker.checkpointing import CheckpointSize, resolve_checkpoint_size
...
from spiker.surrogates import SurrogateName, surrogate_from_name
...
def lif_forward_packed_spikes(
    ...
    *,
    ...
    if backend == "triton":
        require_triton()
        from spiker.triton import lif_forward_packed_spikes as triton_lif_forward_packed_spikes
...
def surrogate_lif_forward(
    ...
    *,
    ...
    if backend == "triton":
        ...
        require_triton()
        from spiker.autograd import triton_surrogate_lif_function
    ...
    if backend == "triton_generated":
        ...
        require_triton()
        from spiker.autograd import generated_triton_surrogate_lif_function
    ...
    *,
    ...
    if backend == "torch":
        ...
        if resolved_checkpoint_size is not None:
            from spiker.autograd import linear_surrogate_lif_checkpoint_function
    ...
    if backend == "triton":
        require_triton()
        if resolved_checkpoint_size is not None:
            from spiker.autograd import triton_linear_surrogate_lif_checkpoint_function
        ...
        from spiker.autograd import triton_linear_surrogate_lif_function
    ...
    if backend == "triton_generated":
        require_triton()
        if resolved_checkpoint_size is not None:
            from spiker.autograd import generated_triton_linear_surrogate_lif_checkpoint_function
        ...
        from spiker.autograd import generated_triton_linear_surrogate_lif_function
...
def linear_surrogate_lif_rate_forward(
    ...
    *,
    ...
    if backend == "torch":
        from spiker.autograd import linear_surrogate_lif_checkpoint_rate_function
...
def linear_surrogate_lif_packed_forward(
    ...
    *,
    ...
    if backend == "triton":
        ...
        from spiker.triton import linear_surrogate_lif_checkpoint_packed_forward
...
def two_layer_surrogate_lif_rate_recompute_forward(
    ...
    *,
    ...
    resolved_checkpoint_size = resolve_checkpoint_size(int(inputs.shape[0]), checkpoint_size)
    from spiker.autograd import two_layer_surrogate_lif_rate_recompute_function
...
def two_layer_surrogate_lif_rate_packed_hidden_forward(
    ...
    *,
    ...
    resolved_checkpoint_size = resolve_checkpoint_size(int(inputs.shape[0]), checkpoint_size)
    from spiker.autograd import two_layer_surrogate_lif_rate_packed_hidden_function
